...
// (Final, Native, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// enum class EFieldResolutionType         Param_ResolutionType                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UFieldSystemMetaDataProcessingResolution* UFieldSystemMetaDataProcessingResolution::SetMetaDataaProcessingResolutionType(enum class EFieldResolutionType Param_ResolutionType)
{
	static class UFunction* Func = nullptr;
...
class URadialIntMask* URadialIntMask::SetRadialIntMask(float Param_Radius, const struct FVector& Param_Position, int32 Param_InteriorValue, int32 Param_ExteriorValue, enum class ESetMaskConditionType SetMaskConditionIn)
{
	static class UFunction* Func = nullptr;
...
// float                                   Param_Radius                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVector                          Param_Position                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// enum class EFieldFalloffType            Param_Falloff                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class URadialFalloff* URadialFalloff::SetRadialFalloff(float Param_Magnitude, float Param_MinRange, float Param_MaxRange, float Param_Default, float Param_Radius, const struct FVector& Param_Position, enum class EFieldFalloffType Param_Falloff)
{
	static class UFunction* Func = nullptr;
...
class UPlaneFalloff* UPlaneFalloff::SetPlaneFalloff(float Param_Magnitude, float Param_MinRange, float Param_MaxRange, float Param_Default, float Param_Distance, const struct FVector& Param_Position, const struct FVector& Param_Normal, enum class EFieldFalloffType Param_Falloff)
{
	static class UFunction* Func = nullptr;
...
class UBoxFalloff* UBoxFalloff::SetBoxFalloff(float Param_Magnitude, float Param_MinRange, float Param_MaxRange, float Param_Default, const struct FTransform& Param_Transform, enum class EFieldFalloffType Param_Falloff)
{
	static class UFunction* Func = nullptr;
...
// enum class EFieldOperationType          Param_Operation                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UOperatorField* UOperatorField::SetOperatorField(float Param_Magnitude, class UFieldNodeBase* Param_RightField, class UFieldNodeBase* Param_LeftField, enum class EFieldOperationType Param_Operation)
{
	static class UFunction* Func = nullptr;
...
// enum class EFieldCullingOperationType   Param_Operation                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UCullingField* UCullingField::SetCullingField(class UFieldNodeBase* Param_Culling, class UFieldNodeBase* Param_Field, enum class EFieldCullingOperationType Param_Operation)
{
	static class UFunction* Func = nullptr;
