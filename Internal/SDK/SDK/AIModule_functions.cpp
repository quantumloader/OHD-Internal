...
// enum class EPathFollowingRequestResult  ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool AAIController::UseBlackboard(class UBlackboardData* BlackboardAsset, class UBlackboardComponent** BlackboardComponent)
{
	...
	if (BlackboardComponent != nullptr)
		*BlackboardComponent = std::move(Parms.BlackboardComponent);
...
enum class EPathFollowingStatus AAIController::GetMoveStatus() const
{
	static class UFunction* Func = nullptr;
...
enum class EPathFollowingAction UPathFollowingComponent::GetPathActionType() const
{
	static class UFunction* Func = nullptr;
...
void UEnvQueryContext_BlueprintBase::ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor** ResultingActor) const
{
	...
	if (ResultingActor != nullptr)
		*ResultingActor = std::move(Parms.ResultingActor);
}
