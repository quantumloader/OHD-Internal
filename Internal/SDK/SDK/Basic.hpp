...
namespace Offsets
{
	constexpr int32 GObjects          = 0x042372C8;
	constexpr int32 AppendString      = 0x00D0BA40;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 ProcessEvent      = 0x00EF6860;
...
// Predefined struct FTestStruct
// 0x0008 (0x0008 - 0x0000)
struct FTestStruct final 
{
public:
	uint16                                        bIsWide : 1;                                       // 0x0000(0x0002)(BitIndex: 0x00, PropSize: 0x0002 (NOT AUTO-GENERATED PROPERTY))
	uint16                                        This4BitSize : 4;                                  // 0x0000(0x0002)(BitIndex: 0x01, PropSize: 0x0002 (NOT AUTO-GENERATED PROPERTY))
	uint16                                        BitPad_0 : 3;                                      // 0x0000(0x0002)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint16                                        SomeBigerField : 6;                                // 0x0000(0x0002)(BitIndex: 0x08, PropSize: 0x0002 (NOT AUTO-GENERATED PROPERTY))
	uint16                                        BitPad_1 : 2;                                      // 0x0000(0x0002)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         thisisDefaultbeifeld : 1;                          // 0x0002(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NOT AUTO-GENERATED PROPERTY))
	uint8                                         Pad_1[0x5];                                        // 0x0003(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// Predefined struct TPair
// 0x0008 (0x0008 - 0x0000)
template<typename ValueType, typename KeyType>
class TPair final 
{
public:
	ValueType                                     First;                                             // 0x0000(0x0001)(NOT AUTO-GENERATED PROPERTY)
	KeyType                                       Second;                                            // 0x0001(0x0001)(NOT AUTO-GENERATED PROPERTY)
};
...
{
public:
	uint8                                         Pad_2[0x28];                                       // 0x0000(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3[0x10];                                       // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5[0x4];                                        // 0x0048(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Offset;                                            // 0x004C(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_6[0x28];                                       // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
