...
{
public:
	enum class EDesiredImageFormat                Format;                                            // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12B1[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	FDelegateProperty_                            OnComplete;                                        // 0x0004(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_12B2[0x46];                                    // 0x001A(0x0046)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
