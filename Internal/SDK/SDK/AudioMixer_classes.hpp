...
public:
	...
	uint8                                         BitPad_37 : 4;                                     // 0x00F0(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_AC3[0x3];                                      // 0x01F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_AC4[0x3];                                      // 0x01F5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_AC5[0x3];                                      // 0x0651(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_AC6[0x4];                                      // 0x065C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_AC7[0x20];                                     // 0x0670(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_AC8[0x30];                                     // 0x06A0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_ACA[0x80];                                     // 0x0028(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_ACB[0x18];                                     // 0x0368(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static void PrimeSoundForPlayback(class USoundWave* SoundWave, FDelegateProperty_ OnLoadCompletion);
	...
	static void StartAnalyzingOutput(class UObject* WorldContextObject, class USoundSubmix* SubmixToAnalyze, enum class EFFTSize FFTSize, enum class EFFTPeakInterpolationMethod InterpolationMethod, enum class EFFTWindowType WindowType, float HopSize);
	...
	static class USoundWave* StopRecordingOutput(class UObject* WorldContextObject, enum class EAudioRecordingExportType ExportType, const class FString& Name, const class FString& Path, class USoundSubmix* SubmixToRecord, class USoundWave* ExistingSoundWaveToOverwrite);
...
{
public:
	uint8                                         Pad_AD5[0x78];                                     // 0x0040(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_AD6[0x38];                                     // 0x0040(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_AD7[0x5C];                                     // 0x0040(0x005C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSubmixEffectReverbSettings            Settings;                                          // 0x009C(0x0038)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_AD8[0x60];                                     // 0x0040(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
