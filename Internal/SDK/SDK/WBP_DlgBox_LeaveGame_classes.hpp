...
class UWBP_DlgBox_LeaveGame_C final  : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticClassImpl<"WBP_DlgBox_LeaveGame_C">();
	}
	static class UWBP_DlgBox_LeaveGame_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_DlgBox_LeaveGame_C>();
	}
};
