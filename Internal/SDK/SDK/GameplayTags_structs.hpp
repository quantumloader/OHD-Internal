...
{
public:
	uint8                                         Pad_1414[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};

// ScriptStruct GameplayTags.GameplayTagReferenceHelper
// 0x0010 (0x0010 - 0x0000)
struct FGameplayTagReferenceHelper final 
{
public:
	uint8                                         Pad_1415[0x10];                                    // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
struct FGameplayTagNode final 
{
public:
	uint8                                         Pad_1416[0x50];                                    // 0x0000(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	enum class EGameplayTagSourceType             SourceType;                                        // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1417[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
