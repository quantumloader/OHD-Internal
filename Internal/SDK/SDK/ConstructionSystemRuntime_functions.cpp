...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// enum class EConstructionSystemToolType  InToolType                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// enum class EConstructionSystemToolType  ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

enum class EConstructionSystemToolType UConstructionSystemComponent::GetActiveToolType() const
{
	static class UFunction* Func = nullptr;
