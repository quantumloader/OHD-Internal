...
{
public:
	uint8                                         Pad_1132[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FPerPlatformBool                       UseBlendTransitions;                               // 0x0000(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      BlendSignificanceValue;                            // 0x0004(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        MaximumNumberConcurrentBlends;                     // 0x0008(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      TickSignificanceValue;                             // 0x000C(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPerPlatformInt                        NumRandomizedInstances;                            // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformBool                       Enabled;                                           // 0x0014(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_1133[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1134[0x2];                                     // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1135[0x1];                                     // 0x0023(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPerPlatformInt                        MaximumNumberOfConcurrentInstances;                // 0x0024(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
