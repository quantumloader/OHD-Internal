...
public:
	...
	uint8                                         Pad_13FA[0x2];                                     // 0x022E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_13FB[0x3];                                     // 0x0225(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_13FC[0x10];                                    // 0x07E0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FCameraFilmbackSettings                FilmbackSettings;                                  // 0x07B0(0x0010)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraFilmbackSettings                Filmback;                                          // 0x07BC(0x0010)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_13FD[0xC];                                     // 0x0844(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
