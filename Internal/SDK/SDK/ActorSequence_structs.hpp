...
{
public:
	enum class EActorSequenceObjectReferenceType  Type;                                              // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_1252[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
