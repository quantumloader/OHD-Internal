...
int32 UMediaPlayer::GetNumTrackFormats(enum class EMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetNumTracks(enum class EMediaPlayerTrack TrackType) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetSelectedTrack(enum class EMediaPlayerTrack TrackType) const
{
	static class UFunction* Func = nullptr;
...
class FText UMediaPlayer::GetTrackDisplayName(enum class EMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
int32 UMediaPlayer::GetTrackFormat(enum class EMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
class FString UMediaPlayer::GetTrackLanguage(enum class EMediaPlayerTrack TrackType, int32 TrackIndex) const
{
	static class UFunction* Func = nullptr;
...
class UMediaSource* UMediaPlaylist::GetNext(int32* InOutIndex)
{
	...
	if (InOutIndex != nullptr)
		*InOutIndex = std::move(Parms.InOutIndex);
...
// enum class EMediaSoundComponentFFTSize  InFFTSize                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
