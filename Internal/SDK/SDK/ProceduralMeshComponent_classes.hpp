...
public:
	...
	static void SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const struct FVector& PlanePosition, const struct FVector& PlaneNormal, bool bCreateOtherHalf, class UProceduralMeshComponent** OutOtherHalfProcMesh, enum class EProcMeshSliceCapOption CapOption, class UMaterialInterface* CapMaterial);
...
{
public:
	uint8                                         Pad_11B7[0x8];                                     // 0x0430(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_11B8[0x6];                                     // 0x043A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x0468(0x0020)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
